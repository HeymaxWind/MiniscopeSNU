%% CNMF_E code
clear; clc
cd 'E:\MiniscopeSNU-master\MiniscopeSNU-master\whole_flow\CNMF-E_kwang\02. CNMF-E'
cnmfe_setup();
cnt = 0;
%%
cnt = cnt +1;
...
for cnt = 1:size(path_save,1)
    ...
    load (filepath);
    cd 'E:\MiniscopeSNU-master\MiniscopeSNU-master\whole_flow\CNMF-E_kwang\02. CNMF-E\demos'
